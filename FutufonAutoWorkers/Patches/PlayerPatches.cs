...
namespace FutufonAutoWorkers.Patches
{
    ...
    internal class PlayerPatches
    {
        ...
        {
            FutufonAutoWorkersPlugin.Log.LogInfo("In Player Awake method Prefix.");
            return true;
        }
        ...
        {
            FutufonAutoWorkersPlugin.Log.LogInfo("In Player Awake method Postfix.");
        }
    }
}